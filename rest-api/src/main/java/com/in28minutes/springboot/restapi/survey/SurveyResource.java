...
public class SurveyResource {
	...
	@RequestMapping(value="/surveys/{surveyId}/question/{questionId}",method=RequestMethod.DELETE)
	...
	@RequestMapping(value="/surveys/{surveyId}/question/{questionId}",method=RequestMethod.PUT)
